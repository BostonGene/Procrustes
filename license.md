...
The BostonGene Procrustes web-based tool is provided to the research community to explore exome capture-based gene expression in comparison with polyA-based RNA-Seq gene expression.
